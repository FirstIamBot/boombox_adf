...
- **Web UI**: Embedded responsive web interface (Preact-based, ~10KB gzipped) with WiFi and Boombox control tabs
...
- **Boombox Integration**: Web-based control interface for Boombox audio player with real-time status updates
